...
@Component({
  selector: 'app-ranking-map3',
  standalone: false,
  templateUrl: './ranking-map3.component.html',
  styleUrl: './ranking-map3.component.css'
})
export class RankingMap3Component implements OnInit {
